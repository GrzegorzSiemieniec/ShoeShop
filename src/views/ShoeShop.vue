                                            ...
                                            <div class="section text-center">
                                                ...
                                                <form v-on:submit="handleSubmit">
                                                  <div class="form-group">
                                                      <input type="email" name="logemail" class="form-style" placeholder="Your Email" id="logemail" autocomplete="off" required v-model="formData.email">
                                                      <i class="input-icon uil uil-at"></i>
                                                  </div>	
                                                  <div class="form-group mt-2">
                                                      <input type="password" name="logpass" class="form-style" placeholder="Your Password" id="logpass" autocomplete="off" required v-model="formData.password">
                                        ...
                                        <div class="center-wrap">
                                            <div class="section text-center">
                                              <form action="">
                                                ...
                                                <input type="submit" class="btn mt-4" value="Submit" id="submitsignup"/>
                                              </form>
                                            </div>
                                        </div>
                                    </div>
